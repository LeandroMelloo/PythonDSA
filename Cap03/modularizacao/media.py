...
def media(lista):
    # media = mean(lista) - jeito facil de calcular a media
...
def moda(lista):
    # moda = mode(lista) - numero que mais se repete em uma lista
    lista_dic = {}
    ...
    maior_repeticao = max(lista_dic.values()) # pegando o maior valor de repetição
